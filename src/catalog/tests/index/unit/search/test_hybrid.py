...
class TestHybridRetriever:
    ...
    def test_init_default_vector_manager(self, mock_session: MagicMock) -> None:
        ...
        with patch("index.search.hybrid.VectorStoreManager") as mock_vm_cls, \
             patch("index.search.hybrid.get_settings") as mock_get_settings:
    ...
    def test_init_custom_vector_manager(
        ...
        with patch("index.search.hybrid.get_settings") as mock_get_settings:
            mock_get_settings.return_value.rag = MagicMock()
    ...
    def test_build_returns_weighted_rrf_retriever(
        ...
        with patch("index.search.hybrid.get_settings") as mock_get_settings, \
             patch("index.search.hybrid.FTSChunkRetriever"):
    ...
    def test_build_uses_settings_values(
        ...
        with patch("index.search.hybrid.get_settings") as mock_get_settings, \
             patch("index.search.hybrid.FTSChunkRetriever") as mock_fts_cls:
            mock_get_settings.return_value.rag = mock_settings
