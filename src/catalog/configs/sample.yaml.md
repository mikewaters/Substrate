...
source:
  ...
  source_path: /Users/mike/Obsidian/Vault
  dataset_name: ${source.type}-vault      # auto-derived from folder name if omitted
  ontology_spec: catalog.integrations.obsidian.ontology.VaultSpec  # dotted import path, or omit for no schema
  force: true                             # reprocess all documents even if unchanged

# embedding: (optional — omit to use application-level SUBSTRATE_EMBEDDING_* settings)
embedding:
