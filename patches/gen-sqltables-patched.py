"""
This is copied from linkml github with patch applied for a defect.
PR: https://github.com/linkml/linkml/pull/2935

Run this instead of `gen-sqltables`, and it needs the project venv.
"""
