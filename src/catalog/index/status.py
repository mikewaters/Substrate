"""index.status - Health/status checks for index subsystem.

Reports on vector store path, FTS table existence, and overall
index health.

Example usage:
    from index.status import check_health, HealthStatus
