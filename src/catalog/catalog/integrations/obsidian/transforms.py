...
Provides FrontmatterTransform for converting raw Obsidian frontmatter
into structured ontology metadata.

Link resolution has been moved to catalog.transform.links (generic) with
the Obsidian strategy in catalog.integrations.obsidian.links.
"""
