...
from ontologizer.relational.models.classifier import TopicSuggestion as TopicSuggestionORM
...
from ontologizer.relational.services.topic_suggestion import (
