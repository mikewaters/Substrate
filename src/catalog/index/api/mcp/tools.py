"""index.api.mcp.tools - MCP tool definitions for RAG search.
...
from index.status import check_health
from index.search.models import SearchCriteria, SearchResult
from index.search.service import SearchService
