"""catalog.search.hybrid_v2 - Weighted RRF hybrid retriever for RAG v2.
...
Example usage:
    ...
    with get_session() as session:
        with use_session(session):
            factory = HybridRetrieverV2(session)
...
class HybridRetrieverV2:
    ...
    using settings from get_settings().rag_v2 for RRF parameters.
    ...
    def __init__(
        ...
        """Initialize the HybridRetrieverV2 factory.
        ...
        logger.debug(
            f"HybridRetrieverV2 initialized with rag_v2 settings: "
    ...
    def build(
        ...
        then wraps them in a WeightedRRFRetriever with settings from rag_v2.
        ...
        if dataset_name:
            ...
            logger.debug(f"Filtering hybrid v2 search by dataset: {dataset_name}")
        ...
        logger.debug(
            f"Built HybridRetrieverV2: fts_k={fts_k}, vector_k={vector_k}, "
