...
from agentlayer.llm.prompts import QUERY_EXPANSION_PROMPT, QUERY_EXPANSION_SYSTEM
...
class TestFallbackBehavior:
    ...
    async def test_fallback_on_llm_error(self, db_session) -> None:
        ...
        with patch("agentlayer.llm.provider.MLXProvider") as mock_provider_cls:
...
class TestSettingsIntegration:
    ...
    def test_respects_max_lex_setting(self, db_session, monkeypatch) -> None:
        ...
        import index.search.query_expansion as query_expansion_module
