...
from ontologizer.relational.models import (  # noqa: F401
    Bookmark,
    Catalog,
    Collection,
    Document,
...
from ontologizer.relational.database import create_alchemy_config
from ontologizer.relational.database import register_all_listeners
...
from ontologizer.relational.models.classifier import (  # noqa: F401
