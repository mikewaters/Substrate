"""Search criteria and result models for index.search.

Pydantic models defining the contract between the orchestration layer
and the search layer. Supports FTS, vector, and hybrid search modes
with dataset filtering and LLM-as-judge reranking.
"""
