...
from index.cli.search import _print_methods_table, search_app
from index.search.models import SearchResult, SearchResults, SnippetResult
...
class TestMethodsCommand:
    ...
    def test_methods_json_output(self) -> None:
        ...
        with patch(
            ...
            with patch(
                "agentlayer.session.use_session",
                return_value=contextlib.nullcontext(),
            ):
                with patch("index.search.service.SearchService", return_value=mock_service):
                    runner = CliRunner()
