...
from ontologizer.relational.database import CURIEBase, IdBase, JSONDict
from ontologizer.domain import TAXONOMY_DEFAULT_NAMESPACE_PREFIX
from ontologizer.utils.slug import (
    generate_identifier,
    generate_slug,
    split_namespace,
)
...
if TYPE_CHECKING:
    ...
    try:
        from ontologizer.relational.models.catalog import catalog_taxonomies, resource_related_topics
    except ImportError:
