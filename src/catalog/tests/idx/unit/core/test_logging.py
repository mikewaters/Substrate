"""Tests for catalog.core.logging module."""

import logging

import pytest
from agentlayer.logging import InterceptHandler, configure_logging, get_logger, is_configured
...
class TestConfigureLogging:
    ...
    def setup_method(self) -> None:
        ...
        import agentlayer.logging as log_module
