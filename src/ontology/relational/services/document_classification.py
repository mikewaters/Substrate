...
from ontology.relational.repository.classifier import DocumentClassificationRepository

logger = logging.getLogger(__name__)
from ontology.relational.models import Taxonomy as TaxonomyORM
from ontology.relational.models import Topic as TopicORM
from ontology.relational.repository import TopicRepository
...
class DocumentClassificationService:
    ...
    def __init__(
        ...
        from ontology.schema.catalog import NewTopicProposal
        ...
        from ontology.schema.classifier import ParentSuggestion
