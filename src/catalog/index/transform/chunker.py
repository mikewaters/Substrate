"""index.transform.chunker - Deterministic line-oriented chunker for document processing.
...
class LineChunker:
    """index.transform.chunker - Deterministic line-oriented document chunker.
